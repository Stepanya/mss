...
<div class="content-wrapper my-0">
    ...
    <div class="row">
      ...
      <div class="col-lg-3">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Assumed total revenue</span>
      ...
      <div class="col-lg-3">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text">Applicant Registrations</span>
            <span class="info-box-number text-center total-apps"></span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="row">
    ...
    <section class="col-lg-6">
      ...
      <div class="card ml-2">
        ...
        <div class="card-body p-1">
          <form class="form-inline sales-form">
            ...
            <div class="form-group m-2">
              <select id="employees" name="employee" class="form-control form-control-sm select2" required></select>
            </div>
            <div class="form-group m-2">
      ...
      <!-- ************************* -->
      <div class="card ml-2">
        <div class="overlay dark recruitment-spinner">
          <div class="spinner-border text-light"></div>
        </div>
        <div class="card-header bg-navy">
          <h5 class="m-0"><i class="fa fa-pie-chart"></i> Recruitment Stats</h5>
        </div>
        <div class="card-body p-1">
          <canvas id="recruitment-chart" width="100" height="100"></canvas>  
        </div>
      </div>
    </section>
    <section class="col-lg-6">
      ...
      <div class="card mr-2">
        ...
        <div class="card-body p-1">
          <form class="form-inline commission-form">
            ...
            <div class="form-group m-2">
              <select id="comm-employees" name="employee" class="form-control form-control-sm select2" required></select>
            </div>
            <button class="btn btn-success btn-sm">Go</button>
          </form>
...
var recruitmentChart = $('#recruitment-chart').get(0).getContext('2d')
...
setTimeout( function() {
  $.ajax({
    url:"../dashboard/fetch_recruitment.php",
    dataType:"json",
    success:function(data) {
      renderRecruitmentChart(data, recruitmentChart)
      $('.recruitment-spinner').fadeOut('slow')
    },
    error:function(e) {
      toastError(e.responseText)
      $('.recruitment-spinner').fadeOut('slow')
...
function renderRecruitmentChart(data, recruitmentChart) {
  ...
  new Chart(recruitmentChart, {
    ...
    data: {
      ...
      labels: [
        'Resume Review',
        'Interview',
        'AXA Discovery Day (Seminar)',
        'Arise',
        'Training',
        'Insurance Commissioner Exam',
        'Encoded (Hired)',
        'No Hire'
      ]
    }
